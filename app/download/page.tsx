...
export default function DownloadPage() {
  ...
  return (
    <section className="card" style={{ maxWidth: '540px', margin: '0 auto', textAlign: 'center' }}>
      ...
      <a
        href="https://github.com/akalabeth77/sdkweb/releases/download/v1.0.4/keswing.apk"
        rel="noreferrer"
        style={{
          display: 'inline-flex',
          alignItems: 'center',
      ...
      <p className="small" style={{ color: '#888', marginTop: '0.5rem' }}>
        {isSk
          ? 'Verzia 1.0.4 · 22 MB · arm64 (moderné Android telefóny)'
          : 'Version 1.0.4 · 22 MB · arm64 (modern Android phones)'}
      </p>
